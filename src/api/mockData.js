...
const COMMANDES = [
  ...
  { id: 4, numero: 'CMD-202512-0004', user_id: 1, user: { id: 1, nom: 'Admin ParaPharma', email: 'admin@parapharmacie.ma', telephone: '+212 5XX-XXXXXX' }, statut: 'en_attente', total: 450, sous_total: 420, frais_livraison: 30, adresse_livraison: 'Av. Mohammed V', ville: 'Rabat', code_postal: '10000', paiement: 'livraison', notes: 'Livrer entre 14h et 17h', created_at: '2025-12-20T09:00:00Z' },
...
const UTILISATEURS = [
  { id: 1, nom: 'Admin ParaPharma', email: 'admin@parapharmacie.ma', telephone: '+212 5XX-XXXXXX', role: 'admin', commandes_count: 1, created_at: '2025-01-01T00:00:00Z' },
...
export function creerCommande(payload) {
  ...
  const commande = {
    id, numero,
    user_id: 1,
    user: { id: 1, nom: 'Admin ParaPharma', email: 'admin@parapharmacie.ma', telephone: '+212 5XX-XXXXXX' },
    statut: 'en_attente',
    total: total + frais,
    sous_total: total,
