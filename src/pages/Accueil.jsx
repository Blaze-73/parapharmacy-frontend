    ...
    <>
      ...
      <section className="relative overflow-hidden h-[520px] md:h-[650px] bg-gray-900">
        {SLIDES.map((sl, i) => (
          ...
          >
            <img src={sl.image} alt={i === 0 ? 'Parapharmacie Elmakhfi — produits de santé, bien-être et beauté' : ''} className={`w-full h-full object-cover ${i === slide ? 'animate-kenburns' : ''}`} loading={i === 0 ? 'eager' : 'lazy'} fetchpriority={i === 0 ? 'high' : 'auto'} decoding="async" />
